        ...
        <>
            ...
            <nav className="bg-gray-200 shadow shadow-gray-300 w-100 px-8 md:px-auto">
                <div className="md:h-16 h-28 mx-auto md:px-4 container flex items-center justify-between flex-wrap md:flex-nowrap">
                    {/* Logo */}
                    <motion.div className="text-indigo-500 md:order-1"
                        initial={{ x: -500 }}
                        animate={{ x: 0 }}
                    ...
                    <div className="text-gray-500 order-3 w-full md:w-auto md:order-2">
                        <motion.ul className="flex font-semibold justify-between"
                    ...
                    <div className="order-2 md:order-3">
                        ...
                        <Link to="/login">
                            <motion.button className="px-4 py-2 bg-indigo-500 hover:bg-indigo-600 text-gray-50 rounded-xl flex items-center gap-2"
                                initial={{ x: 325 }}
                                animate={{ x: 50 }}
                                transition={{ delay: 0.5 }}
                            >
